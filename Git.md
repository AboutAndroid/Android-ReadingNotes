#Git与Github学习
##一. Git与Github的关系
Git：一款免费的、开源的分布式版本控制系统，由Linux的发明者Linus Torvalds开发。
[Github](https://github.com)：主要提供基于Git的版本托管服务，目前Github已经发展为全球最大的开源社区。
也就是说现在 GitHub 上托管的所有项目代码都是基于 Git 来进行版本控制的，所以 Git 只是 GitHub 上用来管理项目的一个工具而已。
##二.Github基本概念
Repository
