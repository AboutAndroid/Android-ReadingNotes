package com.ssyijiu.x5web.utils;
...
import com.ssyijiu.x5web.X5WebView;
...
public class X5WebViewEventHandler extends ProxyWebViewClientExtension implements IX5WebChromeClientExtension{
	...
	@Override
	public void addFlashView(View view, LayoutParams params) {
	}
	...
	@Override
	public boolean onAddFavorite(IX5WebViewExtension extension, String arg1,
			String arg2, JsResult result) {
		return false;
	}
	...
	private WebViewCallbackClient callbackClient = new WebViewCallbackClient() {
		...
		public boolean onTouchEvent(MotionEvent event, View view) {
			...
			return webView.tbs_onTouchEvent(event);
		}
		...
		public void onScrollChanged(int l, int t, int oldl, int oldt, View view) {
			webView.tbs_onScrollChanged(l, t, oldl, oldt);
		}
		...
		public boolean onInterceptTouchEvent(MotionEvent ev, View view) {
			return webView.tbs_onInterceptTouchEvent(ev);
		}
	};
